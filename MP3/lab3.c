...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    sorted_list = NULL;
    int create_size = -1;
    //call count counts how many times appexp is called
    int call_count = 0;
	...
	} else if (num_items == 2 && strcmp(command, "APPEXP") == 0){
	    call_count++;
	    ens_appexp(unsorted_list, call_count, command_number);
        } else if(num_items == 2 && strcmp(command, "SORT") == 0) {
	    ens_sort(unsorted_list, command_number);
